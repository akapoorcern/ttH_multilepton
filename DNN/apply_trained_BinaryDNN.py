...
def network_evaluation(sample_ttree, key_list, sample_name, branches_ttree, branches_reader, tmvareader):
    ...
    histo_sample_title = 'Binary DNN Response %s sample' % sample_name
    histo_sample = ROOT.TH1D(histo_sample_name,histo_sample_title,40,0,1.)
    ...
    for i in range(sample_ttree.GetEntries()):
        ...
        histo_sample.Fill(tmvareader.EvaluateMVA('DNN'))
    histo_sample.Write()
...
def main():
    ...
    classifier_parent_dir = 'BinaryClassifier_DNN_%s' % (classifier_suffix)
    ...
    if classifier_suffix == "ttHvsttJets":
        ...
        ("maxeta","maxeta"),
        ("SR_InvarMassT","SR_InvarMassT"),
        ("mindrlep1jet","mindrlep1jet"),
        ("hadTop_BDT","hadTop_BDT"),
        ("mindrlep2jet","mindrlep2jet")
        ]
    elif classifier_suffix == "ttHvsttV":
        keys_list = [
        ("Jet_numLoose","Jet_numLoose"),
        ...
        ("mindrlep1jet","mindrlep1jet"),
        ("mindrlep2jet","mindrlep2jet"),
        ("corrptlep1","corrptlep1"),
        ("corrptlep2","corrptlep2")
        ]
    ...
    if classifier_suffix == "ttHvsttJets":
        mva_weights_dir = 'BinaryClassifier_DNN_%s/weights/TMVAClassification_2HLs_relu_50_ttbar_DNN.weights.xml' % classifier_suffix
    elif classifier_suffix == "ttHvsttV":
        mva_weights_dir = 'BinaryClassifier_DNN_%s/weights/TMVAClassification_2HLs_relu_50_ttV_DNN.weights.xml' % classifier_suffix
