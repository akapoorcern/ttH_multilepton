...
python evaluate_DNN.py -j /afs/cern.ch/work/j/jthomasw/private/IHEP/ttHML/github/ttH_multilepton/DNN/input_variables_list_allJets-2018-06-15.json -s 2HLs_relu_D+G-VarTrans_0.008-learnRate_40-epochs -i /afs/cern.ch/work/j/jthomasw/private/IHEP/ttHML/github/ttH_multilepton/DNN/samples/2017_updated_MC/2LSS/Rares_2LSS.root
