...
python train_DNN.py -s samples/2017_updated_MC/TrainMVA/ttH_TrainMVA.root -x samples/2017_updated_MC/TrainMVA/TT_TrainMVA.root -y samples/2017_updated_MC/TrainMVA/ttV.root -a relu -l 10 -t D,G -j input_variables_list_2017samples.json -r 0.05 -n 30
