...
def main():
    ...
    output_dir = 'plot_comparison_newsamples/'
    ...
    #input_path_1 = CPlotter.getEOSlsfile(directory='/b/binghuan/Rootplas/TrainMVA_looseWithTH_20190628/ttHnobb_DiLepRegion.root')[0]
    #input_path_2 = CPlotter.getEOSlsfile(directory='/b/binghuan/Rootplas/Rootplas_WithTH_20190629/DiLepRegion/TTH_hww_ctcvcp_DiLepRegion.root')[0]

    input_path_1 = CPlotter.getEOSlsfile(directory='/b/binghuan/Rootplas/Legacy/rootplas_LegacyMVA_20190927/DiLepRegion/ttH2016TrainDNN2L/ttWJets_DiLepRegion.root')[0]
    input_path_2 = CPlotter.getEOSlsfile(directory='/b/binghuan/Rootplas/Legacy/Rootplas_LegacyAll_20191025/DiLepRegion/2016/DiLepRegion/TTW_DiLepRegion.root')[0]
    #input_path_2 = CPlotter.getEOSlsfile(directory='/b/binghuan/Rootplas/TrainMVA_looseWithTH_20190628/ttWJets_DiLepRegion.root')[0]

    #input_path_1 = CPlotter.getEOSlsfile(directory='/b/binghuan/Rootplas/TrainMVA_looseWithTH_20190628/ttZJets_DiLepRegion.root')[0]
    #input_path_2 = CPlotter.getEOSlsfile(directory='/b/binghuan/Rootplas/Rootplas_WithTH_20190629/DiLepRegion/TTZ_DiLepRegion.root')[0]

    #input_path_1 = CPlotter.getEOSlsfile(directory='/b/binghuan/Rootplas/Legacy/rootplas_LegacyMVA_20190927/DiLepRegion/ttH2016TrainDNN2L/ttJets_PS_DiLepRegion.root')[0]
    #input_path_2 = CPlotter.getEOSlsfile(directory='/j/jthomasw/ttH2L/samples/new_ttbar.root')[0]
