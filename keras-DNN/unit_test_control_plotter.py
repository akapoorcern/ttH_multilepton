...
def main():
    ...
    CPlotter.check_dir('invar_control_plots_190319')
    files_list = []
    ...
    files_list.append(input_path_ttH_loose)
    ...
    files_list.append(input_path_ttH_fakeable)

    files_list.append(input_path_ttJ_training)
    ...
    files_list.append(input_path_ttJ_fakeable)

    files_list.append(input_path_ttW_training)
    files_list.append(input_path_ttW_signalregion)
    files_list.append(input_path_ttW_fakeable)

    files_list.append(input_path_ttZ_training)
    files_list.append(input_path_ttZ_signalregion)
    files_list.append(input_path_ttZ_fakeable)
